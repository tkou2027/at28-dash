...
void CollisionMatrix::Initialize()
{
	...
	SetLayerCollision(ColliderLayer::Type::PLAYER, ColliderLayer::Type::DASH_ITEM, true);
	...
	SetLayerCollision(ColliderLayer::Type::PLAYER, ColliderLayer::Type::ENEMY_ATTACK, true);
}