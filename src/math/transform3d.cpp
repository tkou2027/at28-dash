...
void TransformNode3D::SetScaleX(float x)
{
	SetScale({ x, m_transform_local.m_scale.y, m_transform_local.m_scale.z });
}

void TransformNode3D::SetScaleY(float y)
{
	SetScale({ m_transform_local.m_scale.x, y, m_transform_local.m_scale.z });
}

void TransformNode3D::SetScaleZ(float z)
{
	SetScale({ m_transform_local.m_scale.x, m_transform_local.m_scale.y, z });
}
