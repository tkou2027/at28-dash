...
#include "object/dash/common/camera_title.h"
...
void EndingManager::Initialize()
{
	...
	background->SetSprite("sprite/ui/bg_ending");
...
void EndingManager::EnterEaseOut()
{
...
void EndingManager::UpdateEaseOut()
{
