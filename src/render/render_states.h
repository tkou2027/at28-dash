...
public:
	...
	ComPtr<ID3D11DepthStencilState> m_dss_depth_read_leq_stencil_read_eq{ nullptr }; // skybox
	...
	ComPtr<ID3D11DepthStencilState> m_dss_depth_write_leq_stencil_read_eq{ nullptr };
