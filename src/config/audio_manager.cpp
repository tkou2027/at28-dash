...
void AudioManager::Initialize()
{
	...
	m_bgm_paths[static_cast<size_t>(BgmName::BGM)] = "asset/sound/bgm_digitalworld.wav";
	...
	m_se_paths[static_cast<size_t>(SoundEffectName::SHOOT)] = "asset/sound/se_shoot_sound.wav";
	m_se_paths[static_cast<size_t>(SoundEffectName::COUNTDOWN)] = "asset/sound/se_countdown_sound.wav";
	m_se_paths[static_cast<size_t>(SoundEffectName::ATTACK)] = "asset/sound/se_enemy_attack_sound.wav";
