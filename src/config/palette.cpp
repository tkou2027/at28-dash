...
Palette g_palette{
    ...
    SRGBToLinear(Vector4{  1.0f,  0.64706f,  0.0f, 1.0f }), // color_enemy_shell
    SRGBToLinear(Vector4{  1.0f, 1.0f, 0.5f, 1.0f }), // color_enemy_core
    SRGBToLinear(Vector4{  1.0f, 0.0f, 0.0f, 1.0f }), // color_enemy_hurt
	SRGBToLinear(Vector4{ 0.48627f,  0.74902f,  0.74902f, 1.0f }) // dash item
};
